...
const Vendor = () => {
    ...
    const handleSave = async () => {
        ...
        try {
            // ✅ Step 1: Get all selected valid services
            let filteredServicesToSave = services.filter(
                srv => srv.isSelected && (srv.name?.toString().trim() || "") !== ""
            );

            // ✅ Step 2: If overAllPackageCost > 0, divide equally among selected services
            ...
            if (overallCost > 0 && filteredServicesToSave.length > 0) {
                ...
                console.log("✅ Divided services for royalty mode:", filteredServicesToSave);
            }

            // ✅ Step 3: Date-based doc setup
