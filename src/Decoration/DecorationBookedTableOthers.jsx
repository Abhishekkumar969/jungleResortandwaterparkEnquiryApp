                ...
                <tbody>
                  {svcs.map((srv, i) => (
                    <tr key={i}>
                      ...
                      <td style={td}>{srv.remarks || ""}</td>
                      <td style={td}>{srv.qty || 0}</td>
                      <td style={td}>₹{srv.rate || 0}</td>
                      <td style={td}>₹{srv.total || 0}</td>
                      <td style={td}>{srv.royaltyPercent || 0}%</td>
                      <td style={td}>₹{srv.royaltyAmount || 0}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
