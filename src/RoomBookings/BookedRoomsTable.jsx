...
const BookedRoomsTable = ({
    ...
    const [sortBy, setSortBy] = useState("fromDate"); // fromDate | toDate
    const [sortOrder, setSortOrder] = useState("desc"); // asc | desc

    const rows = useMemo(() => {
        const mapped = bookings
            .filter(b => isDateInRange(selectedDate, b.fromDate, b.toDate))
            .map(b => {
                ...
                return {
                    ...
                    isCheckoutDay: selectedDate === b.toDate,
                    rawBooking: b
                };
            });
        ...
        return mapped;
    }, [bookings, selectedDate, sortBy, sortOrder]);

    return (
        <div className="card leads-table-container" style={{ padding: "0px" }}>
            <h3>📋 Bookings on {formatDate(selectedDate)}</h3>
