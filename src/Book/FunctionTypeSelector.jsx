      ...
      {drawerOpen && (
        <div className="drawer-backdrop" onClick={() => setDrawerOpen(false)}>
          <div className="drawer" onClick={(e) => e.stopPropagation()}>
            <div className="drawer-header" style={{ justifyContent: "end", padding: "0px" }} >
              <button style={{ backgroundColor: 'red', padding: "5px 10px" }} onClick={() => setDrawerOpen(false)}>✕</button>
            </div>
            ...
            {/* ✅ Add custom function */}
            <div className="drawer-custom" style={{ display: "flex", gap: "10px" }}>
              <input
              style={{padding:'10px'}}
                type="text"
                value={customType}
              ...
              />
              <button onClick={handleAddCustomType} style={{ width: "100px", padding:"10px" }}>Add</button>
