...
const Tbody = ({ leads, isEditing, handleFieldChange, startEdit, sendToPrintCombined, sendToPrintPayment, moveLeadToDrop, sendToPrint, userPermissions, sortConfig, openExpenseModal, sendToPrintAllMeals }) => {
            ...
            <tbody>
                {sortedLeads.map((lead, index) => (
                    ...
                    >
                        ...
                        <td className="sticky sticky-1" style={{ backgroundColor: userPermissions.venueTypeColors?.[lead.venueType] || "white", fontWeight: 'bold' }}>{leads.length - index}.</td>
